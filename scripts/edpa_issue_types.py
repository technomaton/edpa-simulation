...
Usage:
    python scripts/edpa_issue_types.py list --org technomaton
    python scripts/edpa_issue_types.py setup --org technomaton
    python scripts/edpa_issue_types.py setup --org technomaton --dry-run
    python scripts/edpa_issue_types.py assign --org technomaton --repo edpa-simulation --issue 1 --type Epic
    python scripts/edpa_issue_types.py migrate --org technomaton --repo edpa-simulation
    python scripts/edpa_issue_types.py migrate --org technomaton --repo edpa-simulation --dry-run
